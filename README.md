...
But there's enough [colour](https://willemstad.cc/Showcase) options, over 1 million permutations just from base and accent colours, and that's if you don't count cross-dark/light colour modes (~300 trillion), so you can't use the excuse that "I don't have the right colour".
